...
<body>
    <h1>Edit Existed Ticket of Theater</h1>
</head>
<body>
    ...
    <h1>Fill the New Ticket Info</h1>

    <form action="${pageContext.request.contextPath}/editTicket/{id}(id=${ticket.id})" method="post" modelAttribute="ticket">

        <label for="id">ID:</label>
        <input type="hidden" id="id" name="id" value="${ticketDTO.id}" required><br>
        ...
        <input type="submit" value="Transform Ticket now">
    </form>
</body>
</html>